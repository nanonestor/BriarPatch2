  ...
  event.recipes.thermal
    .smelter(
      Item.of(
        ...
        "{AugmentData:{Type: Upgrade, BaseMod:5f, DynamoEnergy:0.9f}}"
      ),
      [
        "thermal:upgrade_augment_3",
        "8x minecraft:honey_block",
        "8x minecraft:redstone_block",
      ],
      0,
      20000
    )
    .id("kubejs:thermal.smelter.honey_upgrade");

  event.recipes.thermal
    .smelter(
      Item.of(
        "kubejs:rf_coil_xfer_big",
        "{AugmentData:{Type: RF, RFMax:6f, RFXfer:8f}}"
      ),
      [
        "thermal:rf_coil_augment",
        "8x minecraft:honeycomb",
        "8x minecraft:redstone_block",
      ],
      0,
      20000
  ...
  event.recipes.thermal
    .smelter(
      Item.of(
        ...
        "{AugmentData:{Type: Machine, MachineEnergy:3f, MachineSec:0.4f}}"
      ),
      [
        "thermal:machine_output_augment",
        "8x minecraft:redstone_block",
        "8x thermal:basalz_powder",
      ],
      0,
      20000
    )
    .id("kubejs:thermal.smelter.machine_sieve_picky");

  event.recipes.thermal
    .smelter(
      Item.of(
        "kubejs:machine_catalyst_eco",
        "{AugmentData:{Type: Machine, MachineCat:0.4f, MachineEnergy:1.5f}}"
      ),
      [
    ...
    .id("kubejs:thermal.smelter.machine_catalyst_eco");

  event.recipes.thermal
    .smelter(
      Item.of(
        "kubejs:dynamo_output_unstable",
        "{AugmentData:{Type: Dynamo, DynamoPower:2.5f, DynamoEnergy:0.75f}}"
      ),
      [
        "thermal:dynamo_output_augment",
        "16x minecraft:honeycomb",
        "16x thermal:basalz_powder",
      ],
      0,
      20000
    )
