...
event.recipes.thermal.chiller(Item.of('kubejs:machine_efficiency_eco', '{AugmentData:{Type: Machine, MachineEnergy:0.25f, MachineSpeed:-0.5f}}'), ['thermal:machine_efficiency_augment', Fluid.of('productivebees:honey',  1000)],0,10000).id('kubejs:thermal.smelter.machine_efficiency_eco_2');
